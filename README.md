...
This doesn't mean that it won't work, it is very mature and works well. The ESP32 however has more options to extend the program with new features, such as inverter throttling.
